...
namespace SdetBootcampDay1.Exercises
{
    ...
    public class Exercises03
    {
        ...
        public void TryingToOverdrawOnASavingsAccountThrowsExpectedException()
        {
            ...
            ArgumentException OverDrawMessage = Assert.Throws<ArgumentException>(() => {account.Withdraw(100);});

            Assert.That(OverDrawMessage, Is.Not.Null);
            
            Assert.That(OverDrawMessage.Message, Is.EqualTo("You cannot overdraw on a savings account"));
