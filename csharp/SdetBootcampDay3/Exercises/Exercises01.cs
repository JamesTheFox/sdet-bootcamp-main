    ...
    public class Exercises01
    {
        ...
        public async Task GetDataForUser3_CheckServerHeader_ShouldBeCloudflare()
        {
            ...
            RestResponse response = await client.ExecuteAsync(request);
             ...
             string serverHeader = response.Headers
                .Where(x => x.Name.Equals("Server"))
                .Select(x => x.Value)
                .FirstOrDefault();

            Assert.That(serverHeader, Is.EqualTo("cloudflare"));
        }
        ...
        public async Task GetDataForUser4_CheckName_ShouldBePatriciaLebsack()
        {
            ...
            Assert.That(responseBody.SelectToken("name"), Is.EqualTo("Patricia Lebsack"));
        }
        ...
        public async Task GetDataForUser5_CheckCompanyName_ShouldBeKeeblerLLC()
        {
            ...
            Assert.That(responseBody.SelectToken("company.name"), Is.EqualTo("Keebler LLC"));
